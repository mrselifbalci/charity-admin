	...
	return (
		<div className='header-container'>
			<div className='top-header-container'>
				...
				<div className='header-profile-container'>
					...
					<img
						...
						src={typeof adminInfo === 'object' ? adminInfo.mediaId.url : null}
						alt='pic'
						onClick={toggleProfileClass}
					/>
					<div
						className={
							profileInfoClass
								? 'profile-info-container-open'
								: 'profile-info-container-closed'
						}>
			...
			<div
				...
				<div
					className={
						newsClassname === false ? 'dropdown-closed' : 'dropdown-open'
					}>
					<div className='dropdown-item'>
						{' '}
						<BsFillPlusSquareFill /> <a href='/addnews'>Add News</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/news'>News List</a>
					</div>
				</div>
				<div
					className='menu-item'
					...
					<div>
						<BsCardList /> Donations
					</div>
					<div>
						<BsChevronRight
							className={
								donationsArrowClass === true
									? 'sidebar-right-arrow'
									: 'sidebar-down-arrow'
							}
							onClick={(e) => {
				...
				<div
					className={
						donationsClassname === false ? 'dropdown-closed' : 'dropdown-open'
					}>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/ambassadors'> Ambassadors</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/good-donations'> Goods Donations</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/time-donations'> Time Donations</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/giftcard-donations'> Gift Cards</a>
					</div>
				</div>
				<div className='menu-item'>
					<a href='/sliders'>
						{' '}
						<BsFillStarFill /> Sliders
					</a>
				</div>
				<div className='menu-item'>
					<a href='/users'>
				...
				<div className='menu-item'>
					<a href='/emaillist'>
						{' '}
						<BsFillPeopleFill /> Email List
					</a>
				</div>
				<div className='menu-item'>
					{' '}
					<RiContactsBookLine /> <a href='/messages'>&nbsp;Messages</a>
				</div>
				<div
					className={
						faqClassname === false ? 'dropdown-closed' : 'dropdown-open'
					}>
					<div className='dropdown-item'>
						{' '}
						<BsFillPlusSquareFill /> <a href='/addfaq'>Add FAQ</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsFillEyeFill /> <a href='/faqs'>FAQ List</a>
					</div>
				</div>
				<div className='menu-item'>
					<div>
				...
				<div
					className={
						pagesClassname === false ? 'dropdown-closed' : 'dropdown-open'
					}>
					<div className='dropdown-item'>
						{' '}
						<BsInfoSquare /> <a href='/about'>About Us</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsInfoSquare /> <a href='/privacypolicy'>Privacy Policy</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsInfoSquare /> <a href='/termsofuse'>Terms of Use</a>
					</div>
					<div className='dropdown-item'>
						{' '}
						<BsInfoSquare /> <a href='/contactinfo'>Contact Info</a>
					</div>
				</div>
			</div>
		</div>
